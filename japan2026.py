...
events = [
    ...
    # --- TOKYO RETURN (Jan 21-23) ---
    {
        "summary": "Return to Tokyo & Shibuya Sky",
        "desc": "Shinkansen to Tokyo. Shibuya Sky at Sunset.",
        "loc": "SHIBUYA SKY",
        "start": datetime(year, 1, 21, 10, 0),
        "end": datetime(year, 1, 21, 18, 0),
    },
]
